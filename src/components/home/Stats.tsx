...
export default function Stats() {
  return (
    <section className="py-20 bg-white dark:bg-zinc-950 animate-fade-in-up">
          ...
          {stats.map((stat, index) => (
            ...
            >
              <CardContent className="flex flex-col items-center space-y-2">
                {/* Icon */}
                <stat.icon className="w-10 h-10 text-white p-2 rounded-full bg-gradient-to-r dark:bg-none dark:text-white" style={{ backgroundImage: `linear-gradient(to right, var(--tw-gradient-stops))` }} />
